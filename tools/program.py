...
from network.utils.stats import TrainingStats
from network.utils.save_load import save_model
from network.utils.utility import print_dict
from network.utils.logging import get_logger
...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument("-c", "--config", help="configuration file to use", default="./configs/res18_fuse.yml")
